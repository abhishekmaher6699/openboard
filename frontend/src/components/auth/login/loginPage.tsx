    ...
    <AuthCard title="Login">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="flex flex-col gap-1">
          ...
          <input id="username" className={INPUT} placeholder="Enter your username" value={form.username}
        ...
        <div className="flex flex-col gap-1">
          ...
          <input id="password" type="password" className={INPUT} placeholder="Enter your password" value={form.password}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-2 h-2 rounded-full bg-[#1a3a6b] dark:bg-[#f7b731]" />
          <div className="flex-1 h-[2px] bg-[#0a0a0a] dark:bg-[#f5f0e8]" />
        </div>

        <p className="text-center text-[0.8rem] text-[#555] dark:text-[#c8c0b0] tracking-wide">
          Don't have an account?{" "}
          <Link to="/register" className="font-bold text-[#1a3a6b] dark:text-[#f7b731] border-b-2 border-[#1a3a6b] dark:border-[#f7b731] hover:text-[#d62828] hover:border-[#d62828] transition-colors">
            Register
          </Link>
        </p>
      </form>
