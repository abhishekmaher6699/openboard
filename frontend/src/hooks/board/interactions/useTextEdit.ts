...
import type { UseTextEditProps } from "../../../types/canvas"

function getTextareaStyles(
  obj: { x: number; y: number; width?: number; height?: number; type: string; data?: any },
...
export function useTextEdit({
  ...
  function openEditor(id: string) {
    ...
    Object.assign(textarea.style, getTextareaStyles(obj, screenPos, scale))
  ...
  function closeEditor(switchToSelect = true) {
    ...
    if (switchToSelect) onToolChange("select")
  }
